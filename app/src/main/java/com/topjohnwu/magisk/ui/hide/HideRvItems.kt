...
<<<<<<< HEAD:app/src/main/java/com/topjohnwu/magisk/ui/deny/DenyListRvItem.kt
            Shell.cmd("magisk --denylist $arg $pkg \'$name\'").submit()
=======
            Shell.su("magiskhide $arg $pkg \'$name\'").submit()
>>>>>>> parent of 65b0ea792 (MagiskHide is no more):app/src/main/java/com/topjohnwu/magisk/ui/hide/HideRvItems.kt
        }
